...
describe('Participant Get Confirmed Controller', () => {
  it('should throw if the user is not logged in', async () => {
    const { getConfirmedYes } = createCaller(
      requestContext({ db })
    )
  ...
  it('should get a collection of confirmed Participants to a Meal correctly', async () => {
    await expect(
      getConfirmedYes({
        mealId: homeMeal.id,
      })
