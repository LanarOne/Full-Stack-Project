...
describe('Meal GetById Controller', () => {
  ...
  it('should get a home meal by ID correctly', async () => {
    await expect(
      getById({ id: homeMeal.id })
    ).resolves.toEqual(
      expect.objectContaining({
  ...
  it('should get an outside meal by ID correctly', async () => {
    await expect(
      getById({ id: outsideMeal.id })
    ).resolves.toEqual(
      expect.objectContaining({
        eatingDate: outsideMeal.eatingDate,
        outsideMeal: outsideMeal.outsideMeal,
        portions: outsideMeal.portions,
        recipeId: null,
      })
    )
  })
