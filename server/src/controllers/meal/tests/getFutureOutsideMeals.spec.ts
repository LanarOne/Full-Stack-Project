...
describe('Meal Get Future Outside Controller', () => {
  it('should throw if the user is not logged in', async () => {
    const { getFutureOutsideMeals } =
  ...
  const { getFutureOutsideMeals } = createCaller(
    authContext(
      { db },
      {
        id: user.id,
  ...
  it('should get a collection of future outside meals correctly', async () => {
    await expect(
      getFutureOutsideMeals()
